...
if($(window).width() <= 768 )
		{
			$('.loginwrapper').addClass('menuclose');
			$('#left-col').css('margin-left','-220px');
			$('#right-col').css('margin-left', '0px');
		}
$('#mobilemenu').on('click',function() {
		
		if($(window).width() <= 768 )
		{
			$('.loginwrapper').toggleClass('menuclose');			
		}
		var collapsedMargin = $('#right-col').css('margin-left');
    var collapsedLeft = $('#right-col').css('left');
	...
	function toggleMenu1(marginLeft, marginMain) {

    var emailList = ($(window).width() <= 768 && $(window).width() > 640)? 320 : 360;

    if($('#right-col').css('position') === 'relative') {

      $('#left-col').animate({left: marginLeft}, 'fast');
      $('#right-col').animate({left: marginMain}, 'fast');
      ...
      $('#left-col').animate({marginLeft: marginLeft}, 'fast');
      $('#right-col').animate({marginLeft: marginMain}, 'fast');     
