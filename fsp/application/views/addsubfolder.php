<div class="panel">
	...
	<form id="createfolder" method="POST" aria-required="true" action="<?php echo BASE_URL;?>folder/addsubfolder/"> 
	...
	<div class="form-group">
		...
		<input type="hidden" name="parentfolderid" value="<?php echo $folderid;?>"/>
		<input type="hidden" name="parentfoldername" value="<?php echo $foldername;?>"/>
...
<script language="javascript">
		function checkfname(fname){
			...
			var url = '<?php echo BASE_URL.'folder/folderverify/';?>'; // the script where you handle the form input.
			$.ajax({
			   type: "POST",
			   url: url,
