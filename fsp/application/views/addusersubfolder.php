<div class="panel">
	...
	<form id="createfolder" method="POST" aria-required="true" action="<?php echo BASE_URL;?>userfolder/addsubfolder/"> 
	...
	<div class="form-group">
		...
		<input type="hidden" name="parentfolder" value="<?php echo $foldername;?>"/>
