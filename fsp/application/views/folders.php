				...
				<div class="row panel-heading">
					...
					<div class="col-sm-10">
						<div class="col-sm-9 attrbuttons pull-left" >
							...
							<?php if(($datanew!="")&& !empty($datanew)){?>
								<a href="<?php echo BASE_URL; ?>folder/?uid=<?php echo $userdata->id;?>" data-target="#userajax" data-toggle="modal"><i class="fa fa-upload" ></i> Create New Folder</a>
								<a href="<?php echo BASE_URL; ?>company/fileupload/?uid=<?php echo $userdata->id;?>" data-target="#folderajax" data-toggle="modal"><i class="fa fa-cloud"></i> Upload Files</a>
							<?php }else{?>
								<a href="<?php echo BASE_URL; ?>company/userini/" data-target="#userajax" data-toggle="modal">Ini Settings</a>
							<?php }?>
						</div>
					  ...
					  <div class="thmb">
						...
						<div class="btn-group fm-group" style="display: block;">
						  ...
						  <ul class="dropdown-menu pull-right fm-menu" role="menu">
							...
							<li><a onclick="return confirm('Are You Want To Delete This?')" href="<?php echo BASE_URL;?>folder/deletefile/?id=<?php echo $files->id;?>"><i class="fa fa-trash-o"></i> Delete</a></li>
			<?php echo '</ul>
						</div><!-- btn-group -->
						<div class="thmb-prev">';
			if($type =='application'){
